                ...
                <div class="x_content">
                    ...
                    <form method="post" action="{{ route('usuarios.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="email" value="{{ Request::old('email') ?: '' }}" id="email" name="email" class="form-control col-md-7 col-xs-12" required>
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <input type="password" maxlength="10" minlength="3" value="{{ Request::old('password') ?: '' }}" id="password" name="password" class="form-control col-md-7 col-xs-12" required>
