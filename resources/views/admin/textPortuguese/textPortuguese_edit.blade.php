...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>{{ $title }} de texto em português</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('texto-portugues.update', ['id' => 1]) }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('about') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('about', Request::old('about') ?: $textPortuguese->about , ['id' => 'about', 'rows' => 10, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('about_li') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="about_li" value="{{ Request::old('about_li') ?: $textPortuguese->about_li }}" id="about_li" name="about_li" class="form-control" required>
                        ...
                        <div class="form-group{{ $errors->has('about_li_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="about_li_2" value="{{ Request::old('about_li_2') ?: $textPortuguese->about_li_2 }}" id="about_li_2" name="about_li_2" class="form-control" required>
                        ...
                        <div class="form-group{{ $errors->has('about_li_3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="about_li_3" value="{{ Request::old('about_li_3') ?: $textPortuguese->about_li_3 }}" id="about_li_3" name="about_li_3" class="form-control" required>
                        ...
                        <div class="form-group{{ $errors->has('about_experience') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('about_experience', Request::old('about_experience') ?: $textPortuguese->about_experience , ['id' => 'about_experience', 'rows' => 10, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('about_conclusion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('about_conclusion', Request::old('about_conclusion') ?: $textPortuguese->about_conclusion , ['id' => 'about_conclusion', 'rows' => 10, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('service_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_1', Request::old('service_1') ?: $textPortuguese->service_1 , ['id' => 'service_1', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                          ...
                          <div class="form-group{{ $errors->has('service_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_2', Request::old('service_2') ?: $textPortuguese->service_2 , ['id' => 'service_2', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                          ...
                          <div class="form-group{{ $errors->has('service_3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_3', Request::old('service_3') ?: $textPortuguese->service_3 , ['id' => 'service_3', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('service_4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_4', Request::old('service_4') ?: $textPortuguese->service_4 , ['id' => 'service_4', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                          ...
                          <div class="form-group{{ $errors->has('service_5') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_5', Request::old('service_5') ?: $textPortuguese->service_5 , ['id' => 'service_5', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('service_6') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_6', Request::old('service_6') ?: $textPortuguese->service_6 , ['id' => 'service_6', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('service_7') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             {!! Form::textarea('service_7', Request::old('service_7') ?: $textPortuguese->service_7 , ['id' => 'service_7', 'rows' => 7, 'cols' => 54, 'style' => 'resize:yes', 'class'=>'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('schedule') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="schedule" value="{{ Request::old('schedule') ?: $textPortuguese->schedule }}" id="schedule" name="schedule" class="form-control" required>
